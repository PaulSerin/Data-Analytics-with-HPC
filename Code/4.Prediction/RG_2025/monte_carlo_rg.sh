#!/bin/bash -l
#SBATCH --job-name=mc-rg-distributed
#SBATCH --output=logs/mc-rg-distributed-%A_%a.out
#SBATCH --error=logs/mc-rg2--distributed-%A_%a.err
#SBATCH --array=0-3                # 4 tasks: IDs 0 and 3
#SBATCH --nodes=1
#SBATCH --ntasks=1
